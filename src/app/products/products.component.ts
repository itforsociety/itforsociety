...
export class ProductsComponent implements OnInit {
  ...
  scrollEffect() {
    ...
    console.log("translate( " + (1288 + this.scrollValue/2) + ", " + (176+this.scrollValue/2) +")" + "<br>Vertically: " + scrollElement.scrollTop.toString() + "scrollValue" + this.scrollValue + "matrix(" + (0.208 + (this.scrollValue/2)) +", " + (-0.978 + (this.scrollValue/2)) + "," + (0.978+ (this.scrollValue/2)) + "," + (0.708 + (this.scrollValue/2)) + "," + (159.041 + (this.scrollValue/2)) + "," + 1056.417 +")");
    if (this.matrixValue = 246.46){
      //this.matrixValue = this.matrixValue - this.scrollValue/10;
      this.matrixValue = -109.54 + this.scrollValue/2;
    }
    else{
      this.matrixValue = -109.54 + this.scrollValue/2;
    }
