  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe(params => { 
      this.story = new Story (
        this.storiesService.getQuoteByID(Number(params.get('story_id')))        
      );
      ...
      this.meta.updateTag({ property: "og:url", content: "itforsociety.com/quote/" + this.story.story_id + "/" + this.story.story_tag });
      ...
      this.meta.updateTag({ name: "twitter:url", content: "itforsociety.com/quote/" + this.story.story_id + "/" + this.story.story_tag });
